package day27_accessModifiers;
    ...
    public class Circle {
        ...
        public Circle(double radius) {// no need to pass double diameter bc we can calculate it with radius*2
            // if ask you have to provide it every time you call constructor.
            this.radius = radius;
            diameter = radius * 2;
        }
