...
public abstract class Employee { //once you apply abstract keyword == parent class
// abstract class only providing variable and method
    private String name;
    private int age;
    private char gender;
    private String id;
...
//meant to be overridden and cannot be private, static or final
